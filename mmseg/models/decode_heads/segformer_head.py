...
from ..utils import CoorAtte, RepMLPNetUnit
...
class SegFormerHead(BaseDecodeHead):
    ...
    def __init__(self, feature_strides, **kwargs):
        ...
        # self.carafe_c4 = CARAFE(c4_in_channels,scale_factor=8, kernel_size=5, group_size=1)
        self.carafe_c4 = CARAFEPack(c4_in_channels,scale_factor=8)
        self.carafe_c3 = CARAFEPack(c3_in_channels,scale_factor=4)
        self.carafe_c2 = CARAFEPack(c2_in_channels,scale_factor=2)
        self.carafe_c1 = CARAFEPack(c1_in_channels,scale_factor=1)
