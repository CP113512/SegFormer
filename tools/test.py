...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path', default='../tools/output/slyb-/slyformer2.0.b.512x512.80k.py')
    parser.add_argument('--checkpoint', help='checkpoint file', default='tools/output/slyb-/iter_80000.pth')
    parser.add_argument(
