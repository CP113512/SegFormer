...
def parse_args():
    ...
    parser.add_argument(
        '--dir_or_file', help='input gray label directory or file list path', default=r'show_dir')
    parser.add_argument('--output_dir', help='output colorful label directory', default=r'newshow_dir')
...
def get_color_map_list(num_classes):
    ...
    # return color_map
    return [0,0,0,53,119,181,255,0,0,170,170,255,245,128,6]
